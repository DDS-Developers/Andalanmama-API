...
<form action="{{ route('forum.update', ['forum' => $forum ]) }}" method="POST" class="col-8 mx-auto" id="form" @submit="onFormSubmit">
    {{ csrf_field() }}
    @method('PUT')

    <div class="form-group">
        <label for="title">Judul forum</label>
        <input type="text" class="form-control" name="title" id="title" v-model="forum.title">
    </div>

    <div class="form-group">
        <label for="title">URL forum</label>
        <input type="text" class="form-control" name="slug" id="slug" v-model="forum.title">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="editor">
            {!! json_decode($forum->body) !!}
        </div>
    </div>

    <div class="form-group custom-control custom-switch">
        <input type="checkbox" value="1" class="custom-control-input" v-model="forum.highlight" name="highlight" id="highlight" true-value="1" false-value="0">
