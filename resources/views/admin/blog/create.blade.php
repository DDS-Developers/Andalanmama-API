...
<form action="{{ route('blog.store') }}" method="POST" class="col-8 mx-auto" id="form" @submit="onFormSubmit">
    {{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <input type="date" name="publish_at" id="publish_at" class="form-control">
    </div>
        ...
        var app = new Vue({
            ...
            mounted  () {
                ...
                function saveToServer(file) {
                    ...
                    xhr.open('POST', '/upload-blog?api_token={{ $token }}', true);
                    xhr.onload = () => {
                        if (xhr.status === 200) {
