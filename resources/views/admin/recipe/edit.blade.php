...
<form action="{{ route('recipe.update', ['recipe' => $recipe ]) }}" method="POST" class="col-8 mx-auto" id="form">
    {{ csrf_field() }}
    @method('PUT')
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="slug" id="slug" v-model="recipe.slug">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="meta_title" id="meta_title" v-model="recipe.meta_title">
    </div>

    <div class="form-group">
        <label for="title">Meta Description</label>
        <input type="text" class="form-control" name="meta_desc" id="meta_desc" v-model="recipe.meta_desc">
    </div>
    <div class="form-group custom-control custom-switch">
        <input type="hidden" name="status" value="0"/>
        <input type="checkbox" value="1" class="custom-control-input" v-model="recipe.status" name="status" id="status" true-value="1" false-value="0">
        <label class="custom-control-label" for="status">Published The Recipe?</label>
    </div>
    <div class="form-group custom-control custom-switch">
        <input type="hidden" name="highlight" value="0"/>
        <input type="checkbox" value="1" class="custom-control-input" v-model="recipe.highlight" name="highlight" id="highlight" true-value="1" false-value="0">
